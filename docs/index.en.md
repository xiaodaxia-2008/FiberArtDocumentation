---
title: Introduction to FiberArt Automated Fiber Placement Software
description: >
    FiberArt is an independently developed Automated Fiber Placement/Automated Fiber Winding (AFP/AFW) trajectory planning and simulation software. 
    It can export NC programs in formats such as Siemens G-code and KUKA KRL, and is suitable for fiber placement planning and simulation on various complex curved surfaces. 
    It supports various gantry-type and robotic fiber placement machines. A 30-day trial is available.
...
![](./assets/fiberart_plan_spar_demo.gif){ data-title="FiberArt trajectory planning for C-spar parts" width=75% }
///caption | >
FiberArt trajectory planning for C-spar parts
///

![](./assets/fiberart_simulation_spar_demo.gif){ data-title="FiberArt simulation for C-spar parts" width=75% }
///caption | >
